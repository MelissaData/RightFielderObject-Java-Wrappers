...
gcc -fpic -c -I$mdRFPath -I$JavaIncludeDirectory1 -I$JavaIncludeDirectory2 mdRightFielderJavaWrapper.cpp
gcc -g -shared mdRightFielderJavaWrapper.o -o libmdRightFielderJavaWrapper.so -L$mdRFPath -lmdRightFielder -pthread
