# Melissa - Right Fielder Object Java Wrappers

## Purpose
This is the code for you to run Right Fielder Object in Java.
...
```
$ git clone https://github.com/MelissaData/RightFielderObject-Java-Wrappers.git
$ cd RightFielderObject-Java-Wrappers
```

### Copy wrappers to your project folder
Import the `com` folder, and `mdRightFielderJavaWrapper.dll` (Windows) or `libmdRightFielderJavaWrapper.so` (Linux) to your project, and include the following line in your code to begin using the wrapper.
...
It is important to note that you must be able to initialize the Visual Studio Developer Command Prompt environment for `x86_x64` to generate `mdRightFielderJavaWrapper.dll`.
...
#### Configure Script
If you want to generate `libmdRightFielderJavaWrapper.so`, you will execute the `BuildRightFielderJavaWrapper.sh` script. This may require you to configure some path variables in `BuildRightFielderJavaWrapper.sh`.
...
----------------------------------------
## See also
- [Melissa - Right Fielder Object Windows Java](https://github.com/MelissaData/RightFielderObject-Java)
- [Melissa - Right Fielder Object Linux Java](https://github.com/MelissaData/RightFielderObject-Java-Linux)
